import { METADATA_SYSTEM_PROMPT, type MetadataState, type TranscriptMessage, openAICompletionsTransport, refreshConversationMetadata } from "../lib/swarm-conversation-metadata.ts";
import { injectContextBlocks } from "../lib/swarm-context.ts";
import { currentContextBlocks } from "./swarm-prompt.ts";
