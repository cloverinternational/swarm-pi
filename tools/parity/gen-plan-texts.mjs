...
// literals in upstream/swarm-sdk so the plan-mode hook texts Pi injects are
...
const extract = (file, fn) => {
  const src = readFileSync(resolve(root, "upstream/swarm-sdk", file), "utf8");
 ...
 * GENERATED from upstream/swarm-sdk — do not edit by hand.
